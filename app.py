...
def generate_summary_from_multiple_docs(input_doc, prefix="create a coherent story summary: "):
    ...
    inputs = {key: value.to("cpu") for key, value in inputs.items()}  # ✅ CPU に移動
    ...
    with torch.no_grad():
        output_ids = model_t5.generate(
            **inputs,
            max_length=512,  # ✅ もっと大きくする
            num_beams=5,
            early_stopping=True  # ✅ 追加
        )
    
    if output_ids is None or output_ids.numel() == 0:  # ✅ 修正
